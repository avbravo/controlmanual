...
@Named
@ViewScoped
public class ReinicioRemotoConfirmarController implements Serializable {
    ...
    private String tokenIngresado = "0000";
// </editor-fold>
...
// </editor-fold>
     ...
     */
    public ReinicioRemotoConfirmarController() {
    }
...
// </editor-fold>
 ...
 return "/faces/operacionexitosa.xhtml";
            ...
            JsfUtil.errorMessage("onCommandButtonReinicioRemoto()" + e.getLocalizedMessage());
        }
        return "";
    }
// </editor-fold>
